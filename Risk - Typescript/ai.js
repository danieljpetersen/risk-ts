...
var Pathfinding = (function () {
    ...
    Pathfinding.prototype.findPath = function (start, goal) {
        ...
        this.onToCheckedList = new Array(this.territories.length);
        ...
        while (true) {
            ...
            this.toCheck = this.toCheck.sort(function (a, b) {
                return a.resistence - b.resistence;
            });
        }
    };

    Pathfinding.prototype.validTerritoryToCheck = function (territory) {
